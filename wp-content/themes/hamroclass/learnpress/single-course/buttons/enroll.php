...
<form name="enroll-course" class="enroll-course" method="post" enctype="multipart/form-data">
	...
	<?php if(method_exists($course, 'get_id')){ ?>
	...
	<button class="lp-button button button-enroll-course button-primary">
		<?php echo esc_html( apply_filters( 'learn-press/enroll-course-button-text', esc_html__( 'Enroll', 'hamroclass' ) ) ); ?>
	</button>
